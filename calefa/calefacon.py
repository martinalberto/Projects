     ...
     while (1):
          ...
          if (estado != old_estado):
               ...
               try:
                  ...
                  text_send="curl http://www.pilarruizgaite.com/calefa_alb.php?q=IMP_cambioEstado_%d_%d\n" %(old_estado, estado)
          ...
          for x in range(0, WAIT_TIME):
               ...
               sleep((0.5-(estado*0.3)))
          try:
                  text_send="curl http://www.pilarruizgaite.com/calefa_alb.php?a=estado_%d\n" %(estado)
                  sys.stderr.write(text_send)
                  os.system(text_send)
          except: 
